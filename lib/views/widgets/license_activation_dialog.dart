                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _infoRow('Annual Subscription Renewal:', 'KES 20,000 / year (Payable to quantyx001)'),
                      _infoRow('Lead Developer:', 'Davies Mukoya'),
                      _infoRow('Company:', 'Quantyx Labs'),
                      _infoRow('Email Contact:', 'info@quantyx.co.ke'),
                      _infoRow('WhatsApp / M-Pesa / Buy Coffee:', '+254702687799'),
                      _infoRow('M-Pesa Account / Till:', 'quantyx001'),
                    ],
                  ),
                ),
                const SizedBox(height: 20),
